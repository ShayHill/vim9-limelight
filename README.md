...
Configuration can be done from setting global values in your vimrc. Be aware that values in the per-colorscheme `g:limelight_config` will override other config values.
